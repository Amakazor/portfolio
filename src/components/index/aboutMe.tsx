        ...
        <>
            ...
            <MaxWidthContainer>
                ...
                <Paragraph {...ParagraphProps}>
                    ...
                    Besides webdevelopment I also write applications and scripts in other
                ...
                <Paragraph {...ParagraphProps}>
                    I like to think about programming as my passion, as I love broadening
                    my knowledge about technologies, languages or some super-specific
                    algorithms for an obscure problem that has been puzzling me for hours
                    - that's the feeling i code for. That, and the ability to constanly
                    improve my skills and becoming able to create even more things.
                </Paragraph>
                <Paragraph {...ParagraphProps}>
